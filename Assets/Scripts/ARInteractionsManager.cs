...
public class ARInteractionsManager : MonoBehaviour
{
    ...
    private bool isRotating; // Nueva bandera para controlar la rotación
    ...
    void Update()
    {
        ...
        if (Input.touchCount > 0)
        {
            ...
            if (touchOne.phase == TouchPhase.Began)
            {
                ...
                isRotating = false; // Reinicia la bandera cuando comienza un nuevo toque
            }

            if (Input.touchCount == 1 && touchOne.phase == TouchPhase.Moved && !isRotating)
            {
            ...
            if (Input.touchCount == 2)
            {
                ...
                isRotating = true; // Marca que se está rotando el objeto
